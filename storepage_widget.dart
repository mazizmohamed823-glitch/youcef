...
import 'storepage_model.dart';
export 'storepage_model.dart';

/// Create a store page with modern look
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProductRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductRecord> storepageProductRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final storepageProductRecord = storepageProductRecordList.isNotEmpty
            ? storepageProductRecordList.first
            : null;
                                          ...
                                          Stack(
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: Image.asset(
                                                  'assets/images/Capture_dcran_2026-01-30_123359.png',
                                                  width: double.infinity,
                                                  height: 140.0,
                                                  fit: BoxFit.cover,
                                                ),
                                                    ...
                                                    children: [
                                                      ...
                                                      StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<RedemptionsRecord>
                                                              iconButtonRedemptionsRecordList =
                                                              snapshot.data!;
                                                          // Return an empty Container when the item does not exist.
                                                          if (snapshot
                                                              .data!.isEmpty) {
                                                          ...
                                                          final iconButtonRedemptionsRecord =
                                                              iconButtonRedemptionsRecordList
                                                                      .isNotEmpty
                                                                  ? iconButtonRedemptionsRecordList
                                                                      .first
                                            ...
                                            children: [
                                              ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(16.0),
                                                child: Image.asset(
                                                  'assets/images/Capture_dcran_2026-01-30_123525.png',
                                                  width: double.infinity,
                                                  height: 140.0,
                                                  fit: BoxFit.cover,
                                                ),
                                            ...
                                            children: [
                                              ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(16.0),
                                                child: Image.asset(
                                                  'assets/images/Capture_dcran_2026-01-31_052724.png',
                                                  width: double.infinity,
                                                  height: 140.0,
                                                  fit: BoxFit.cover,
                                                ),
                                            ...
                                            children: [
                                              ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(16.0),
                                                child: Image.asset(
                                                  'assets/images/Capture_dcran_2026-01-31_054632.png',
                                                  width: double.infinity,
                                                  height: 140.0,
                                                  fit: BoxFit.cover,
                                                ),
