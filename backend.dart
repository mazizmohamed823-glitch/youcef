...
import 'schema/redemptions_record.dart';
import 'schema/mail_record.dart';
import 'schema/comments_record.dart';
import 'schema/videi_views_record.dart';
...
export 'schema/redemptions_record.dart';
export 'schema/mail_record.dart';
export 'schema/comments_record.dart';
export 'schema/videi_views_record.dart';
...
/// Functions to query RedemptionsRecords (as a Stream and as a Future).
Future<int> queryRedemptionsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RedemptionsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RedemptionsRecord>> queryRedemptionsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RedemptionsRecord.collection,
      RedemptionsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RedemptionsRecord>> queryRedemptionsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query VideiViewsRecords (as a Stream and as a Future).
Future<int> queryVideiViewsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VideiViewsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VideiViewsRecord>> queryVideiViewsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VideiViewsRecord.collection,
      VideiViewsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VideiViewsRecord>> queryVideiViewsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
