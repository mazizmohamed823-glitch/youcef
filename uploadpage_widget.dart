  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VideosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VideosRecord> uploadpageVideosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final uploadpageVideosRecord = uploadpageVideosRecordList.isNotEmpty
            ? uploadpageVideosRecordList.first
            : null;
                            ...
                            onFieldSubmitted: (_) async {
                              await VideosRecord.collection
                                  ...
                                  .set(createVideosRecordData(
                                    title: uploadpageVideosRecord?.title,
                                  ));
                            },
                            autofocus: false,
                            enabled: true,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDataNp0 = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadDataNp0 = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataNp0 =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadDataNp0 =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
                            ...
                            await VideosRecord.collection
                                .doc()
                                .set(createVideosRecordData(
                                  uploaderld: uploadpageVideosRecord?.videoUrl,
                                  videoUrl:
                                      _model.uploadedFileUrl_uploadDataNp0,
                                  creatorRef: currentUserReference,
                                  createdAt: uploadpageVideosRecord?.createdAt,
                                  description: _model.textController2.text,
                                  likes: uploadpageVideosRecord?.likes,
                                  earnedMoney:
                                      uploadpageVideosRecord?.earnedMoney,
                                  title: _model.textController1.text,
                                  views: uploadpageVideosRecord?.views,
                                ));
                            context.safePop();
                          },
                          text: 'Publish',
                      ...
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (_) async {
                          await VideosRecord.collection
                              ...
                              .set(createVideosRecordData(
                                description:
                                    uploadpageVideosRecord?.description,
                              ));
                        },
                        autofocus: false,
                        enabled: true,
